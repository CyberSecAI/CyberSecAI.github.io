...
Large Language Models (LLMs) are instead transforming how we write traditional software, creating what we might call "Software 1.0 Redux"—where AI feeds and enhances human programming rather than eating it entirely.
...
This creates an interesting duality: while AI handles low-level implementation details, human developers increasingly work at higher levels of abstraction, using natural language to specify intent and behavior. The skill shifts from syntax mastery to effective requirements management, architecture, and system design, and clean coding principles. 
...
But LLMs have transformed software engineering.

The "More Continuity between Requirements – Documentation – Test – SW" is playing out as 
...
#### Upstream Artifacts: The New Core Deliverables
This transformation elevates the importance of what a16z calls "upstream artifacts"—the specifications, contracts, and architectural decisions that guide AI-driven development workflows.
...
Everything-as-code, infrastrucutre as code, policy-as-code, diagrams as code, and other artifacts are becoming more important.

 

The lines between a developer and a Requirements Analyst blur. The lines between human an machine blur.
